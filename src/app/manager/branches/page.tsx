    ...
    return (
        <div className={''}>
            <div className={'flex justify-between '}>
                ...
                <div>
                    <button type="button" className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2"><i className="bi bi-plus me-2"></i>Add New Branch</button>
                </div>
            </div>
            <div className="my-4 ">
